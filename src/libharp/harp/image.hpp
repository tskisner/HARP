...
namespace harp {
  ...
  class image : public boost::enable_shared_from_this < image > {
    ...
    public :
      ...
      virtual void read ( size_t startrow, size_t startcol, harp::dense_mat_view & data ) { return; }
      virtual void write ( std::string const & path, size_t startrow, size_t startcol, harp::dense_mat_view & data ) { return; }
