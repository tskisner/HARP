...
void harp::test_image_fits ( string const & datadir ) {
  ...
  string fitspath = datadir + "/image_fits.fits.out";
  ...
  string serialpath = datadir + "/image_fits_serialize.xml.out";
  {
  ...
  img->write ( fitspath, img_data, img_inv, sky );
